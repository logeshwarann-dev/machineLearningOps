...
def preprocess_data(data: pd.DataFrame):
    """Preprocess the data by splitting features (X) and target (y), and scaling the data."""
...
def train_xgb_model(X_train, y_train):
    ...
    return hyperparameter_tuning(xgb, param_grid, X_train, y_train)
...
def main():
    ...
    log_to_mlflow(xgb_model, "XGBoost", X_train, X_test, y_train, y_test)

    # Use ensemble learning for improved performance
    ...
    log_to_mlflow(ensemble_model, "Ensemble", X_train, X_test, y_train, y_test)
